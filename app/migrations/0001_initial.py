...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=80, verbose_name='Название модели')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.BooleanField(default=True, verbose_name='Готовность получения заказов')),
            ],
            options={
